...
df = pd.read_excel('./RawData/Previous_campaigns/Aerosol WESP on Dry Bed_10-16SEP2022.xlsx', sheet_name='PI-Daten', header=4)
...
x_train, x_test = x.split_before(pd.Timestamp("16-Sep-22 04:10:00"))
y_train, y_test = y.split_before(pd.Timestamp("16-Sep-22 04:10:00"))
...
Conv_FGD_start = pd.to_datetime('13-Sep-22 12:50:00')
Conv_FGD_end = pd.to_datetime('13-Sep-22 18:50:00')
HP_FGD_WESPON_start = pd.to_datetime('13-Sep-22 19:30:00')
HP_FGD_WESPON_end = pd.to_datetime('14-Sep-22 01:30:00')
HP_FGD_WESPON_Drybed_start = pd.to_datetime('14-Sep-22 17:00:00')
HP_FGD_WESPON_Drybed_end = pd.to_datetime('15-Sep-22 10:00:00')
HP_FGD_WESPON2_start = pd.to_datetime('16-Sep-22 01:30:00')
HP_FGD_WESPON2_end = pd.to_datetime('16-Sep-22 13:30:00')
Conv_FGD2_start = pd.to_datetime('16-Sep-22 14:00:00')
Conv_FGD2_end = pd.to_datetime('16-Sep-22 23:00:00')


plt.axvspan(Conv_FGD_start, Conv_FGD_end, color='blue', alpha=0.3, label = 'conventional FGD')
plt.axvspan(HP_FGD_WESPON_start, HP_FGD_WESPON_end, color='red', alpha=0.3, label = 'High perfomance FGD, WESP on')
plt.axvspan(HP_FGD_WESPON_Drybed_start, HP_FGD_WESPON_Drybed_end, color='green', alpha=0.3, label = 'High perfomance FGD, WESP on, dry bed active')
plt.axvspan(HP_FGD_WESPON2_start, HP_FGD_WESPON2_end, color='red', alpha=0.3)
